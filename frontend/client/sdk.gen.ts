...
import type { InviteAdminData, InviteAdminResponses, ListAdminsData, ListAdminsResponses, ListAuditLogsData, ListAuditLogsResponses, ChangePasswordData, ChangePasswordResponses, InitAccountData, InitAccountResponses, InitAccountErrors, LoginData, LoginResponses, LoginErrors, LogoutData, LogoutResponses, MeData, MeResponses, MeErrors, LookupSetupTokenData, LookupSetupTokenResponses, LookupSetupTokenErrors, RequestPasswordResetData, RequestPasswordResetResponses, RequestPasswordResetErrors, ResetPasswordData, ResetPasswordResponses, ResetPasswordErrors, ListEventsData, ListEventsResponses, CreateEventData, CreateEventResponses, GetNewsletterTemplateData, GetNewsletterTemplateResponses, DeleteEventData, DeleteEventResponses, GetEventData, GetEventResponses, UpdateEventData, UpdateEventResponses, HealthCheckData, HealthCheckResponses, ListOrganizersData, ListOrganizersResponses, CreateOrganizerData, CreateOrganizerResponses, ListOrganizersAdminData, ListOrganizersAdminResponses, UpdateOrganizerPermissionsData, UpdateOrganizerPermissionsResponses, DeleteOrganizerData, DeleteOrganizerResponses, GetOrganizerData, GetOrganizerResponses, UpdateOrganizerData, UpdateOrganizerResponses, GenerateSetupTokenData, GenerateSetupTokenResponses, GetPublicEventData, GetPublicEventResponses, GetPublicEventErrors, GetPublicOrganizerData, GetPublicOrganizerResponses, GetPublicOrganizerErrors } from './types.gen';
...
export const getNewsletterTemplate = <ThrowOnError extends boolean = false>(options?: Options<GetNewsletterTemplateData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetNewsletterTemplateResponses, unknown, ThrowOnError>({
...
export const updateOrganizerPermissions = <ThrowOnError extends boolean = false>(
    options: Options<UpdateOrganizerPermissionsData, ThrowOnError>
) => {
