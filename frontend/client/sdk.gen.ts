...
export const getAllEventsIcal = <ThrowOnError extends boolean = false>(options?: Options<GetAllEventsIcalData, ThrowOnError>) => (options?.client ?? client).get<GetAllEventsIcalResponses, unknown, ThrowOnError>({ url: '/api/ical', ...options });

export const getClEventsIcal = <ThrowOnError extends boolean = false>(options?: Options<GetClEventsIcalData, ThrowOnError>) => (options?.client ?? client).get<GetClEventsIcalResponses, unknown, ThrowOnError>({ url: '/api/ical/cl', ...options });

export const getThiEventsIcal = <ThrowOnError extends boolean = false>(options?: Options<GetThiEventsIcalData, ThrowOnError>) => (options?.client ?? client).get<GetThiEventsIcalResponses, unknown, ThrowOnError>({ url: '/api/ical/thi', ...options });

export const getOrganizerEventsIcal = <ThrowOnError extends boolean = false>(options: Options<GetOrganizerEventsIcalData, ThrowOnError>) => (options.client ?? client).get<GetOrganizerEventsIcalResponses, unknown, ThrowOnError>({ url: '/api/ical/{organizer_id}', ...options });
...
export const updateAccountEmail = <ThrowOnError extends boolean = false>(options: Options<UpdateAccountEmailData, ThrowOnError>) => (options.client ?? client).put<UpdateAccountEmailResponses, unknown, ThrowOnError>({
