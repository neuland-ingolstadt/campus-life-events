...
export function OrganizerForm({
  ...
  onSave: (data: CreateOrganizerRequest | UpdateOrganizerRequest) => Promise<void> | void;
  isLoading?: boolean;
}) {
  ...
  const onSubmit = async (values: OrganizerFormValues) => {
    ...
    } as CreateOrganizerRequest | UpdateOrganizerRequest;
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6 max-w-5xl">
        <div>
          <h2 className="text-xl font-bold tracking-tight">Vereinsinformation</h2>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Das Hinzufügen einer Beschreibung hilft Leuten, dein Verein besser zu verstehen und seine Aktivitäten zu erkennen." className="min-h-[120px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Adding a description helps people to better understand your club and its activities." className="min-h-[120px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Optional website URL for the organizer</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Optional Instagram profile URL</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
