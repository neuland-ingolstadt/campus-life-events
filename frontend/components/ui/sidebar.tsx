...
import { PanelBottom, PanelLeftIcon } from "lucide-react";
		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				<SheetContent
					...
					data-slot="sidebar"
					data-mobile="true"
					className="bg-sidebar text-sidebar-foreground p-0 [&>button]:hidden h-[80vh] max-h-[600px] rounded-t-xl border-sidebar-border"
					side="bottom"
				>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			data-sidebar="header"
			className={cn(
				"flex flex-col gap-2 p-2 group-data-[collapsible=icon]:px-0",
				className,
			)}
			{...props}
		/>
